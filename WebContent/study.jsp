                    ...
                    <div class="accordion" id="zA7n">
                        <ul class="accordion__ul">
                            ...
                            <li class="accordion__li"><%
                                ...
                                <a href="index_wei.jsp" class='iframe'><img class="accordion__img" src="images/menu/5.jpg" alt="Image Alt" /></a></li>
                        </ul>
                    </div>
                </div>     
            </div>
            ...
            <div id="main">
                ...
                <div id="mei2">
                    ...
                    <div id="containertabs">
                        <div id="contentstabs">
                            <div>
                                <img src="images/study/1_1.jpg" width="535px" height="500px" />
                            </div>
                            <div>
                                <img src="images/study/1_2.jpg" width="535px" height="500px" />
                            </div>
                            <div>
                                <img src="images/study/1_3.jpg" width="535px" height="500px" />
                            </div>
                            <div>
                                <img src="images/study/1_4.jpg" width="535px" height="500px" />
                            </div>
                            <div>
                                <img src="images/study/1_5.jpg" width="535px" height="500px" />
                            </div>
                        </div>
                    </div>
                </div>                
